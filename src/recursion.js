...
var sum = function(array) {
	...
	sumArr = Number(arr.pop());
	return sumArr + (sum(arr));
...
/*
input: 2 integers
output: an array of numbers between given integers
base case:
if x and y are equal {
	return []; //top of call stack
}
...
var palindrome = function(string) {
	...
	iterate with i = 1
	var index = 1
		//compare string[i] -> string[string.length - i - 1]
